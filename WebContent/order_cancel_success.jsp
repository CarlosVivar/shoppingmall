														...
														<div class="tube">
															<div class="tab_show">
																...
																<div
																	...
																	<h4><%=LanguegeBUS.getValue("cancel_step3", lang)%>:&nbsp;

																		<%=LanguegeBUS.getValue("cancel_completed", lang)%></h4>
																...
																<div
																	style="background-color: #fbfbfb; border: 2px solid #e6e6e6; text-align: center; padding: 10px 10px; line-height: 1.5em">
																	<%
																		if (request.getAttribute("cancelSuccessfull") != null) {
																	%>
																	<%=LanguegeBUS.getValue("notice_cancel_successfull",lang)%>
																	<div><%=LanguegeBUS.getValue("cancel_thanks", lang)%></div>
																	<%
																	}else{
																	%>
																		<%=LanguegeBUS.getValue("notice_cancel_unsuccessfull",lang)%>
																...
																<div style="text-align: center">
																		<button type="button" style="padding: 0 10px" onclick="top.location.href='order.html?defaultId=1'"><%=LanguegeBUS.getValue("shopping_list", lang)%></button>
																	<button type="button" onclick="top.location.href='index.html'"
