																	...
																	<table class="carttable" border="0"
																		...
																		<tbody>
																			<tr style="border: #fff 1px solid;">
																				<td class="title" width="10%"><%=LanguegeBUS.getValue("no.", lang)%></td>
																				...
																				<td class="title" width="30%"><%=LanguegeBUS.getValue("total", lang)%></td>
																				<td class="title" width="30%"><%=LanguegeBUS.getValue("", lang)%>deliver
																					cost</td>
																				<td class="title" width="30%"><%=LanguegeBUS.getValue("", lang)%>order
																					status</td>
																				<td class="title" width="30%"><%=LanguegeBUS.getValue("", lang)%>deliver
																					status</td>
																				<td class="title" width="30%"><%=LanguegeBUS.getValue("", lang)%>update</td>
																			...
																			<%
																				List<Productorderdetail> nList = ProductorderdetailBUS
																																					...
																																					for (int i = 0; i < nList.size(); i++) {
																																						...
																																						Deliver deliver = DeliverBUS.getDeliverByPODetail(prodet.getProductOrderDetailId(), lang);
																			...
																			<tr style="border: #fff 1px solid;">
																				...
																				<td align="center">
																				<a alt="View" href="orderdetail.html?Id="  > <img height="15" width="20"  src="css/images//icon-reply.gif" name="edit" title="Update" > </a>
																				</td>
																			</tr>
