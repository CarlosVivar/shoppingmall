					...
					<div style="height: 208px;" class="spyWrapper">
						<ul class="ctnAlert_inside spy">
							...
							<li style="height: 26px; opacity: 1; display: block;"><a
								...
								<a rel="nofollow" href="" class="viewmore"><%=LanguegeBUS.getValue("return_exchange", lang)%> <%=LanguegeBUS.getValue("exc_status", lang)%></a>
							</li>
																...
																<%
																	...
																	if (id != null) {
																		...
																		if (productODetail != null) {
																			...
																			if (productODetail.getOrderDetailStatusId() == 4) {
																						Exchangeorder exchangeorder = ExchangeOrderBUS.getExchangeOrderByPODetailID(pODetailID, lang);
																						if (exchangeorder != null) {
																						submitted=exchangeorder.getRequiredDate()+"";
																						
																						cancelReason=(exchangeorder.getReason()!="null") ? exchangeorder.getReason() : "";
																						
																						memoToSeller=(exchangeorder.getMemoToSeller()!=null) ? exchangeorder.getMemoToSeller() : "";
																						Exchangestatus exchangestatus=ExchangeStatusBUS.getExchangeStatus(exchangeorder.getExchangeStatus().getExchangeStatusId(),lang);
																						if(exchangestatus!=null) status=exchangestatus.getExchangeStatusName();		
																						System.out.print("exchangeorder.getExchangeId(): "+exchangeorder.getExchangeId());
																						Confirm confirm=ConfirmBUS.getCurrentReturnExchangeConfirm(exchangeorder.getExchangeId(),lang);
																						if(confirm!=null && confirm.getMemo()!=null){
																							memoToBuyer=confirm.getMemo();
																						}
																						
																						}
																			}
																			System.out.print("memoToBuyer: "+memoToBuyer);
																%>
																	...
																	<table width="100%" class="info" id="tab1_table">
																		<tbody>
																			<tr>
																				...
																				<td bgcolor="#FAF8EA" class="title" width="13%"><%=LanguegeBUS.getValue("refund", lang)%> <%=LanguegeBUS.getValue("exc_status", lang)%>
																			</tr>
																			<tr>
																...
																<div>
																	...
																	<table width="100%" class="info">
																		<tr>
																			...
																			<td class="select" width="80%" style="text-align: left;padding-left:4px"><%=product.getProductName()%></td>																		
																		</tr>
																		<tr>
																			<td class="title" bgcolor="#FAF8EA"><%=LanguegeBUS.getValue("exc_reason", lang)%></td>
																			<td class="select" style="text-align: left;padding-left:4px">
																			<select>
																			<option><%=cancelReason %></option>
																			</select>
																			<textarea rows=2 cols="69"
																					readonly="readonly"><%=memoToSeller %>			
																					</textarea>
																			</td>																		
																		</tr>
																		<tr>
