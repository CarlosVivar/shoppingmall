...
<%
	...
	.getAttribute("listOrderReturnExchange");
	if(lst==null){
		getServletContext().getRequestDispatcher("/ManageReturnExchangeOrderController").forward(request, response);
	}
...
<script type="text/javascript">
	...
	function loadReturnExchangeOrder(){
		location.replace("<%=ServletUtils.getBaseUrl(request)%>/applyreturnexchangeorder.html");
	}
</script>
												...
												<DIV class="corner-right-bot">
													<DIV class="category-title">
														...
														<div class="tube">
															<div>
																<form
																	action="<%=ServletUtils.getBaseUrl(request)%>/ManageReturnExchangeOrderController"
																	method="post">
																	...
																	<table class="Search" width="100%">
																		<tbody>
																			<tr>
																				...
																				<td width="85%" class="select">
																					<input onclick="loadReturnExchangeOrder()"
																						type="radio" id="rdo_cancel_1" name="rdo_cancel" />
																				<label for="rdo_cancel_1"
																					style="margin-right: 40px;"><%=LanguegeBUS.getValue("apply_return_exchange", lang)%>
																				</label> <input type="radio" id="rdo_cancel_2"
																						name="rdo_cancel" checked="checked" />
																				<label for="rdo_cancel_2"><%=LanguegeBUS.getValue("returning_exchanging", lang)%></label>
																				</td>
																			</tr>
																			<tr>
																	...
																	<table width="100%" class="manageorderTable"
																		...
																		<%
																			if (lst != null) {
																				for (Productorderdetail productODetail : lst) {
																					...
																					Exchangeorder exchangeorder = ExchangeOrderBUS
																							.getExchangeOrderByPODetailID(pODetailID, lang);
																					Exchangestatus exchangestatus = ExchangeStatusBUS
																							.getExchangeStatus(exchangeorder
																		...
																		<tr>
																			...
																			<td align="center"><a style="color: #0066BC "
																				href="orderdetailinfo.html?id=<%=pODetailID%>"><%=product.getProductName()%></a>
																			</td>
																			...
																			<td align="right">
																				...
																				%><%=exchangestatus.getExchangeStatusName()%> <%
 	}
 %>
																			</td>
																			<td align="center"><a
																				href="return_exchange_info.html?id=<%=pODetailID%>"
																				style="color: #0066BC ">See detail</a>
																			</td>
																		</tr>
																		<%
																			}
