...
<meta name="description" content="ELI Mall Shopping Admin" />
 ...
 <body id="travel">
	...
	<div id="content">
	 ...
	 <li style="height: 26px; opacity: 1; display: block;"><a rel="nofollow"  href="index.html" class="viewmore">ADMIN  </a> &nbsp; <img src="css/images/icon-arrow1.gif">&nbsp;
	 <a rel="nofollow"  href="product.html" class="viewmore">MANAGE SALES</a></li>					
                ...
                <div class="center_box_ucp">
                    <div class="box_ucp_inside">
                        ...
                        <div id="usual2">
                            ...
                            <ul class="tab">
                                <li><a rel="tabs1" href="#tabs1" class="selected"><span>Admin</span></a></li>
                                <li><a rel="tabs2" href="#tabs2"><span>Seller</span></a></li>
                                <li><a rel="tabs3" href="#tabs3"><span>user</span></a></li>
                            </ul>
                            <div class="clear"></div>
                            <table  id="tabs1" class="table_ucp" border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tbody><tr>
                                    ...
                                    <td class="lstitle" width="50">Role&nbsp;</td>
                                  	...
                                  	<tr class="order_row"><td class="nonSearch" colspan="4" align="center">Currently, there aren`t accounts.</td></tr>
