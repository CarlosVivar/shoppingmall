<%-- 
    Document   : paypalfunctions
    Created on : Jun 2, 2011, 11:20:10 AM
    Author     : admin
--%>
...
<%!
	...
	*********************************************************************************/
	public HashMap CallShortcutExpressCheckout( String paymentAmount, String currencyCodeType, String paymentType, 
												...
												HttpSession session)
	{
		//System.out.print("paymentAmount: "+paymentAmount);
		...
		*/
		...
		//System.out.print("strAck: "+strAck);
	...
	*********************************************************************************/
	public HashMap ConfirmPayment( String finalPaymentAmount, HttpSession session, HttpServletRequest request)
	{
	    ...
	    */
	    ...
	    //System.out.print("DoExpressCheckoutPayment");
	...
	public HashMap deformatNVP( String pPayload )
	{
		...
		while (stTok.hasMoreTokens())
		{
			...
			if (stInternalTokenizer.countTokens() == 2)
			{
				...
				//System.out.print("put: "+key.toUpperCase()+"="+ value);
			}
		}
		return nvp;
	}
